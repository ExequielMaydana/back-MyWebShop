...
var isMail = /*#__PURE__*/function () {
  ...
  return function isMail(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var verifiCsrfToken = function verifiCsrfToken(req, res, next) {
  var tokens = csrf({
    cookie: true
  });
  var secret = tokens.secretSync();
  var create = tokens.create(secret);
  if (!create) return res.status(400).json({
...
module.exports = {
  ...
  verifiCsrfToken: verifiCsrfToken
};