...
var getAllClients = /*#__PURE__*/function () {
  ...
  return function getAllClients(_x4, _x5, _x6) {
...
var getClientById = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var idClient, clientById;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          idClient = req.params.id;
          _context3.next = 3;
          return client.findById(idClient).populate({
            path: "roles",
            select: "name -_id"
          });
        case 3:
          clientById = _context3.sent;
          if (clientById) {
            res.status(200).json({
              client: clientById
            });
            ...
            res.status(400).json({
              message: "client with id ".concat(idClient, " does not exist")
            });
            next();
          }
        case 5:
  ...
  return function getClientById(_x7, _x8, _x9) {
...
var updateClient = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var idClient, newDataCLient, clientUpdate;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          idClient = req.params.id;
          newDataCLient = req.body;
          _context4.prev = 2;
          _context4.next = 5;
  ...
  return function updateClient(_x10, _x11, _x12) {
...
var deleteClient = /*#__PURE__*/function () {
  ...
  return function deleteClient(_x13, _x14, _x15) {
...
var getMyUser = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return client.find({
            _id: req.userId
          }).select("-token -_id -password -createdAt -updatedAt").populate({
            path: "roles",
            select: "name -_id"
          });
        case 3:
        ...
        case 7:
          ...
          res.status(400).json("error getMyUser", _context6.t0);
          next();
        case 11:
        case "end":
  ...
  return function getMyUser(_x16, _x17, _x18) {
    return _ref6.apply(this, arguments);
  };
}();
var updateMyUser = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res, next) {
    var newDataMyUser, myUserUpdate;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          newDataMyUser = req.body;
          _context7.next = 3;
          return client.findOneAndUpdate({
            _id: req.userId
          }, newDataMyUser, {
        ...
        case 3:
          myUserUpdate = _context7.sent;
          try {
            res.status(200).json({
              message: "The user was successfully modified",
              myUserUpdate: myUserUpdate
            });
          } catch (error) {
            res.status(400).json({
              error: error
  ...
  return function updateMyUser(_x19, _x20, _x21) {
