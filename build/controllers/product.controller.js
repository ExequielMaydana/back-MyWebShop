...
var postProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, name, description, category, sizes, garment_type, brand, tags, price, stock, offer, imageUrl, publicId, result, newProduct;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, name = _req$body.name, description = _req$body.description, category = _req$body.category, sizes = _req$body.sizes, garment_type = _req$body.garment_type, brand = _req$body.brand, tags = _req$body.tags, price = _req$body.price, stock = _req$body.stock, offer = _req$body.offer;
          imageUrl = "";
          publicId = "";
          if (!req.file) {
            _context.next = 12;
